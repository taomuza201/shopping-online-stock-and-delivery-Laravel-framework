...
class Products_ownerController extends Controller
{
    /**
    ...
    {
        $product = Product::select('*')->where('products_owner_id',Auth::user()->id)->get();
        return view('products-owner.index',compact('product'));
    }
