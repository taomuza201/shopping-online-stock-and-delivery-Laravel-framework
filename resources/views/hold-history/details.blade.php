                ...
                <div class="card-header border-0">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-4 text-md-right   text-center pb-2 "> 
                            ...
                            <button type="button" class="btn btn-success "onclick="printbill()">พิมพ์ใบเสร็จ</button>
                            <button type="button" class="btn btn-default "onclick="printdelivery()">พิมพ์ใบส่งของ</button>
                            @endif
                        ...
                        <table class="table table-hover table-flush table-striped" id="maintable">
                            ...
                            <tbody>
                                ...
                                <tr class="align-middle">
                                    <td class="td-center align-middle"></td>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td></td>
                                    <td></td>
                                    <td class="text-red">ราคาสุทธิ : {{$total}} บาท</td>
                                    <td></td>
                                </tr>
                            </tfoot>
                        </table>
