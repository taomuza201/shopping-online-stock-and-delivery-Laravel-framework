        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{url('/post-store/'.$product->products_id)}}" method="POST" enctype="multipart/form-data" id="Mainform">
                    ...
                    <center> <button class="btn btn-primary mb-3" style="width: 50%" onclick="count()">อัพเดพ</button>
                    </center>
                </div>
