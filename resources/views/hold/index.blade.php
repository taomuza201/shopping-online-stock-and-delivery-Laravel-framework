        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-header border-0">
                    ...
                    <div class="row">
                        <div class="col">
                            <h2 class="mb-4 " style="font-weight: 600">คำสั่งซื้อ </h2>
                        </div>
                        <div class="col-12 col-md-5  text-md-right">
                            <button type="button" class="btn btn-primary"
                                onclick="showmodal()">เพิ่มการคำสั่งซื้อ</button>
                                ...
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="mainModalLabel">เพิ่มการคำสั่งซื้อ</h5>
                                        ...
                                        <div class="modal-body text-left">
                                            ...
                                            <form id="mainform" method="POST">
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label">ชื่อ - นามสกุล ผู้ซื้อ:</label>
                                                    <input type="text" class="form-control" id="holds_name"
                                                        name="holds_name" required>
                                                </div>

                                                <div class="form-group">
                                                    <label class="control-label">เบอร์โทร ผู้ซื้อ:</label>
                                                    <input type="text" class="form-control" id="holds_tel"
                                                        name="holds_tel" required>
                                                </div>

                                                <div class="form-group">
                                                    <label class="control-label">รายละเอียด ผู้ซื้อ:</label>
                                                    <textarea name="holds_detail" id="holds_detail" cols="30" rows="5"
