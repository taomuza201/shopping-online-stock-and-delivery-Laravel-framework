        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-header border-0">
                    ...
                    <div class="row">
                        <div class="col">
                            <h2 class="mb-4 " style="font-weight: 600">เพิ่มรายการสินค้า</h2>
                        </div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{url('products-store/'.$proposal->proposals_id)}}" method="POST" enctype="multipart/form-data" id="Mainform">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="products_name" name="products_name" value="{{$proposal->proposals_name}}"
                                        required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="products_name_short" name="products_name_short" 
                                        required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="number" class="form-control" name="products_price_cost" value="{{$proposal->proposals_price_cost}}"
                                            id="products_price_cost" required min="1">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="number" class="form-control" name="products_price"  value="{{$proposal->proposals_price}}"
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="number" class="form-control" name="products_amount" value="{{$proposal->proposals_amount}}"
                                            id="products_amount" required min="1">
                                        <div class="input-group-append">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <textarea name="products_about_short" id="products_about_short" rows="5"
                                        style="min-height: 100px;" required class="form-control">{{$proposal->proposals_about}}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <textarea name="products_about_size" id="products_about_size" rows="5"
                                        style="min-height: 100px;"  class="form-control"></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <center> <img src="{{ asset('uploads_image') }}/{{$proposal->proposals_cover_photo}}" id="show_products_cover_photo"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <textarea name="products_story" id="products_story" rows="20" required>{{$proposal->proposals_story}}</textarea>
                            </div>
                        </div>
                        ...
                        <center> <button class="btn btn-primary mb-3"  type="submit" 
                            style="width: 50%">เพิ่มสินค้า</button>
                    </center>
                </div>
                </form>
...
<script>
   ...
   $('#products_photo').imageUploader();
    ...
    plugins: 'print preview powerpaste casechange importcss tinydrive searchreplace autolink autosave save directionality advcode visualblocks visualchars fullscreen image link media mediaembed template codesample table charmap hr pagebreak nonbreaking anchor toc insertdatetime advlist lists checklist wordcount tinymcespellchecker a11ychecker textpattern noneditable help formatpainter pageembed charmap mentions quickbars linkchecker emoticons advtable'
        ...
        images_upload_url: "{{route('upload.product')}}",
